"""
This script parses a configuration file (yaml), replicates the requested
function directory according to the repetitions desired, and generates jug
tasks for each run.
...
def prepare_spearmint(expt_path,
                      function='braninpy',
    ...
    for i in range(nreps):
        ...
        seeddir = '{0:03d}'.format(i)
        destination_path = os.path.join(expt_path, subdir, seeddir)
